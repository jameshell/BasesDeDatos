<%-- 
    ...
    Created on : Feb 20, 2017, 12:46:21 AM
    Author     : james
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="jumbotron">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="RegistroCursosControlador" method="POST"> <!--ATENCION: la palabra action indica el tipo de acción que va a realizar el formulario-->
                            ...
                            <div class="form-group">
                                <label><h3>Duración</h2>
                                </label>
                                <input type="text" class="form-control" name="duracionCurso">
                                <p class="help-block">Ej: 15</p>
                            </div>
                              <div class="form-group">
                                <label><h3>Identificación</h2>
                                </label>
                                <input type="text" class="form-control" name="idProfesor">
                                <p class="help-block">Ej: 15</p>
                            </div>
