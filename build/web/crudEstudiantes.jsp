<%-- 
    ...
    Created on : Feb 20, 2017, 3:37:19 AM
    Author     : james
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="jumbotron">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="BorradoEstudiantes" method="POST"> <!--ATENCION: la palabra action indica el tipo de acción que va a realizar el formulario-->
            
                              
                            <div class="form-group">
                                <label><h3>Identificación del Estudiante que desea Eliminar del archivo:</h3>
                                </label>
