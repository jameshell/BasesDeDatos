 ...
 * @author james
 */
public class BorradoInscripciones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {                              
                ...
                inscripciondao.borrar(numeroInscripciones);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BorradoInscripciones</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BorradoInscripciones at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
