<%-- 
    Document   : crudProfesores
    Created on : Feb 20, 2017, 4:39:11 AM
    Author     : james
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="jumbotron">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="BorradoProfesores" method="POST"> <!--ATENCION: la palabra action indica el tipo de acción que va a realizar el formulario-->
            
                              
                            <div class="form-group">
                                <label><h3>Identificación del Profesor que desea Eliminar del archivo:</h3>
                                </label>
